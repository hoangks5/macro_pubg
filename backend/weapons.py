...
WEAPONS = [
    # --- Assault Rifles ---
    {"id": "m416",    "name": "M416",        "type": "AR",  "rpm": 700, "recoil": 16.0},
    {"id": "akm",     "name": "AKM",         "type": "AR",  "rpm": 600, "recoil": 23.0},
    {"id": "scarl",   "name": "SCAR-L",      "type": "AR",  "rpm": 650, "recoil": 17.0},
    {"id": "m16a4",   "name": "M16A4",       "type": "AR",  "rpm": 900, "recoil": 14.0},
    {"id": "m762",    "name": "Beryl M762",  "type": "AR",  "rpm": 700, "recoil": 29.0},
    {"id": "g36c",    "name": "G36C",        "type": "AR",  "rpm": 650, "recoil": 16.5},
    {"id": "aug",     "name": "AUG A3",      "type": "AR",  "rpm": 700, "recoil": 13.5},
    {"id": "qbz",     "name": "QBZ95",       "type": "AR",  "rpm": 650, "recoil": 16.0},
    {"id": "mk47",    "name": "Mk47 Mutant", "type": "AR",  "rpm": 600, "recoil": 22.0},
    {"id": "groza",   "name": "Groza",       "type": "AR",  "rpm": 700, "recoil": 21.0},
    {"id": "k2",      "name": "K2",          "type": "AR",  "rpm": 670, "recoil": 17.0},
    {"id": "ace32",   "name": "ACE32",       "type": "AR",  "rpm": 600, "recoil": 19.5},
    {"id": "famas",   "name": "FAMAS",       "type": "AR",  "rpm": 1100,"recoil": 14.5},

    # --- SMG ---
    {"id": "ump45",   "name": "UMP45",       "type": "SMG", "rpm": 600, "recoil": 11.0},
    {"id": "vector",  "name": "Vector",      "type": "SMG", "rpm": 1100,"recoil": 7.0},
    {"id": "tommy",   "name": "Tommy Gun",   "type": "SMG", "rpm": 700, "recoil": 11.5},
    {"id": "mp5k",    "name": "MP5K",        "type": "SMG", "rpm": 900, "recoil": 8.5},
    {"id": "pp19",    "name": "PP-19 Bizon", "type": "SMG", "rpm": 700, "recoil": 9.0},
    {"id": "p90",     "name": "P90",         "type": "SMG", "rpm": 950, "recoil": 8.0},
    {"id": "uzi",     "name": "Micro UZI",   "type": "SMG", "rpm": 1200,"recoil": 7.0},
    {"id": "js9",     "name": "JS9",         "type": "SMG", "rpm": 750, "recoil": 8.5},

    # --- LMG ---
    {"id": "m249",    "name": "M249",        "type": "LMG", "rpm": 750, "recoil": 18.0},
    {"id": "dp28",    "name": "DP-28",       "type": "LMG", "rpm": 550, "recoil": 19.5},
    {"id": "mg3",     "name": "MG3",         "type": "LMG", "rpm": 990, "recoil": 21.0},

    # --- DMR (auto / bán tự động) ---
    {"id": "mini14",  "name": "Mini 14",     "type": "DMR", "rpm": 350, "recoil": 13.5},
    {"id": "sks",     "name": "SKS",         "type": "DMR", "rpm": 350, "recoil": 23.0},
    {"id": "slr",     "name": "SLR",         "type": "DMR", "rpm": 320, "recoil": 28.0},
    {"id": "qbu",     "name": "QBU",         "type": "DMR", "rpm": 350, "recoil": 16.0},
    {"id": "mk12",    "name": "Mk12",        "type": "DMR", "rpm": 400, "recoil": 17.0},
    {"id": "mk14",    "name": "Mk14 (Auto)", "type": "DMR", "rpm": 700, "recoil": 31.0},
    {"id": "vss",     "name": "VSS",         "type": "DMR", "rpm": 600, "recoil": 10.5},
    {"id": "dragunov","name": "Dragunov",    "type": "DMR", "rpm": 400, "recoil": 24.0},

    # --- Pistol (full-auto) ---
    {"id": "p18c",    "name": "P18C",        "type": "PISTOL", "rpm": 850, "recoil": 8.0},
    {"id": "skorpion","name": "Skorpion",    "type": "PISTOL", "rpm": 850, "recoil": 8.5},
]
